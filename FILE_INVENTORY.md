...
- `docs/ARCHITECTURE.md` - platform decision notes for web build and future desktop shell.
...
The browser build intentionally does not modify Windows audio drivers or headset firmware directly. It exports safe configuration text that can be used in tools such as Equalizer APO. Direct device control belongs in a signed desktop shell with explicit user approval.
