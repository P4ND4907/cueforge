...
Status: passing locally for `0.2.0-alpha.6`.
...
- [x] CueForge state object exists.
  - Evidence: `src/core/cueforgeState.js`, `cueforgeStateV2.version = 0.2.0-alpha.6`.
