# CueForge Social Posting Plan

Goal: keep CueForge visible without sounding spammy. Every post should invite real testers, show progress, or ask a useful audio question.
...
Explain one CueForge feature in plain human terms.

Friday: test night invite  
Invite people into Discord for one real match test.

Saturday: clip/replay ask  
Ask for moments where audio helped or failed.
...
App: https://p4nd4907.github.io/cueforge/
Invite: https://discord.gg/vyQwyJ49v
```
...
- Never post passwords, phone numbers, DOB, raw device IDs, recovery info, or private screenshots.
